...
function MedicareContent() {
  ...
  // Tier badges (Strong/Solid X) computed against the *filtered* set so badges
  // reflect what the user is actually looking at, not the global universe.
  // Only top-3 per category get badged; pure function — fine to recompute.
