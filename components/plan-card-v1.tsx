...
/**
 * V1 — Minimal Scorecard
 * White frosted-glass card. Clean header, single lavender stat strip, CTA row.
 */
...
const STATS = (d: number, m: number, b?: PlanBenefits) => [
      ...
      <div className="p-5">
        ...
        <div className="flex items-start justify-between gap-4">
          ...
          <div className="text-right shrink-0">
            <div className={`text-3xl font-bold tracking-tight ${isFeatured ? "text-[#22c55e]" : "text-gray-900"}`}>
              ${monthlyPremium}
